        ...
        <div class="bg-smoke main-search-container round-border">
            <div class="d-flex justify-content-around">
                ...
                <div class="full-rounded-border white-bg py-2 px-2">
                    <div class="d-flex">
                        <input class="no-border no-outline" placeholder="What are you looking for?"
                            v-model="nameOfProduct" @input="handleNameOfProduct">
                        <span> | </span>
                        <CategoryDropDown />
                    </div>
                </div>
                <div>
                    <button @click="handleNameAndCategory"
                        class="no-border no-outline full-rounded-border bg-blue text-white py-2 px-3">Search</button>
                </div>
...
const handleNameAndCategory = () => {
    ...
    store.state.filters['category__category__category_name'] = store.state.selectedCategoryName
