<template>
  <div class="container">
    <h2 class="color-b">
      Category<span v-if="product.category" class="color-b">
        /{{ product.category.sub_category_name }} </span
  ...
  <div class="container d-flex justify-content-between my-4">
      ...
      <div class="py-2 px-2">
        <div v-for="image in product.product_image" class="py-1">
          <img
            ...
            height="70px"
            width="80px"
            @click="handleDisplayImage(image)"
          />
        </div>
      </div>
      <div class="py-2 px-2">
    ...
    <div class="px-5 py-2">
      ...
      <div class="pb-5">
        ...
        <p>
          Certifications:
          <span v-for="certificate in product.certifications">
    ...
    <div>
      <div class="pb-3 d-flex">
        <img
          src="https://thebuyhive.com/buy/img/value1.c6cf714a.svg"
          alt=""
          height="40px"
          width="40px"
          class="mx-3 my-2"
        />
        <div>
          <span style="color: black; text-wrap: wrap; text-align: justify"
            >Qualified and Verified Manufacturers</span
          >
        </div>
      </div>
      <div class="pb-3 d-flex">
        <img
          src="https://thebuyhive.com/buy/img/value2.e77aed11.svg"
          alt=""
          height="40px"
          width="40px"
          class="mx-3 my-1"
      ...
      <div class="pb-3 d-flex">
        <img
          src="	https://thebuyhive.com/buy/img/value3.71166266.svg"
          alt=""
          height="40px"
          width="40px"
          class="mx-3"
      ...
      <div class="pb-3 d-flex">
        <img
          src="https://thebuyhive.com/buy/img/value4.2b9f535a.svg"
          alt=""
          height="40px"
          width="40px"
          class="mx-3 my-1"
